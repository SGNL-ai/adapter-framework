...
func (LDAPSearchScope) Descriptor() protoreflect.EnumDescriptor {
	return file_proto_grpc_proxy_v1_ldap_proto_enumTypes[1].Descriptor()
}

func (LDAPSearchScope) Type() protoreflect.EnumType {
	return &file_proto_grpc_proxy_v1_ldap_proto_enumTypes[1]
}

func (x LDAPSearchScope) Number() protoreflect.EnumNumber {
	return protoreflect.EnumNumber(x)
}
...
func (x *LDAPSearchOpRequest) GetScope() LDAPSearchScope {
	...
	return LDAPSearchScope_LDAP_SEARCH_SCOPE_BASE
}
...
func (x *LDAPOperationRequest) GetSearchRequest() *LDAPSearchOpRequest {
	if x != nil {
		if x, ok := x.Operation.(*LDAPOperationRequest_SearchRequest); ok {
...
func (*LDAPOperationRequest_SearchRequest) isLDAPOperationRequest_Operation() {}
...
func (x *LDAPOperationResponse) Reset() {
	*x = LDAPOperationResponse{}
	mi := &file_proto_grpc_proxy_v1_ldap_proto_msgTypes[10]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*LDAPOperationResponse) Descriptor() ([]byte, []int) {
	return file_proto_grpc_proxy_v1_ldap_proto_rawDescGZIP(), []int{10}
}
...
const file_proto_grpc_proxy_v1_ldap_proto_rawDesc = "" +
	...
	"\fnew_superior\x18\x04 \x01(\tR\vnewSuperior\"\xee\x01\n" +
	"\x13LDAPSearchOpRequest\x12\x17\n" +
	"\abase_dn\x18\x01 \x01(\tR\x06baseDn\x12>\n" +
	"\x05scope\x18\x02 \x01(\x0e2#.sgnl.grpc_proxy.v1.LDAPSearchScopeH\x00R\x05scope\x88\x01\x01\x12\x16\n" +
	"\x06filter\x18\x03 \x01(\tR\x06filter\x12\x1e\n" +
	"\n" +
	"attributes\x18\x04 \x03(\tR\n" +
	"attributes\x12\x1d\n" +
	"\n" +
	"size_limit\x18\x05 \x01(\x05R\tsizeLimit\x12\x1d\n" +
	"\n" +
	"time_limit\x18\x06 \x01(\x05R\ttimeLimitB\b\n" +
	"\x06_scope\"\x88\x04\n" +
	"\x14LDAPOperationRequest\x12\x10\n" +
	"\x03url\x18\x01 \x01(\tR\x03url\x12\x17\n" +
	"\abind_dn\x18\x02 \x01(\tR\x06bindDn\x12(\n" +
	"\rbind_password\x18\x03 \x01(\tB\x03\x80\x01\x01R\fbindPassword\x12E\n" +
	...
	"\x11modify_dn_request\x18\a \x01(\v2'.sgnl.grpc_proxy.v1.LDAPModifyDNRequestH\x00R\x0fmodifyDnRequest\x12P\n" +
	"\x0esearch_request\x18\b \x01(\v2'.sgnl.grpc_proxy.v1.LDAPSearchOpRequestH\x00R\rsearchRequestB\v\n" +
	"\toperation\"|\n" +
	...
	"\x1dLDAP_MODIFY_OPERATION_REPLACE\x10\x02*m\n" +
	"\x0fLDAPSearchScope\x12\x1a\n" +
	"\x16LDAP_SEARCH_SCOPE_BASE\x10\x00\x12\x1f\n" +
	"\x1bLDAP_SEARCH_SCOPE_ONE_LEVEL\x10\x01\x12\x1d\n" +
	"\x19LDAP_SEARCH_SCOPE_SUBTREE\x10\x02B8Z6github.com/sgnl-ai/adapter-framework/pkg/grpc_proxy/v1b\x06proto3"
...
var file_proto_grpc_proxy_v1_ldap_proto_enumTypes = make([]protoimpl.EnumInfo, 2)
var file_proto_grpc_proxy_v1_ldap_proto_msgTypes = make([]protoimpl.MessageInfo, 11)
var file_proto_grpc_proxy_v1_ldap_proto_goTypes = []any{
	(LDAPModifyOperation)(0),      // 0: sgnl.grpc_proxy.v1.LDAPModifyOperation
	(LDAPSearchScope)(0),          // 1: sgnl.grpc_proxy.v1.LDAPSearchScope
	(*LDAPSearchRequest)(nil),     // 2: sgnl.grpc_proxy.v1.LDAPSearchRequest
	(*LDAPSearchResponse)(nil),    // 3: sgnl.grpc_proxy.v1.LDAPSearchResponse
	(*LDAPAttribute)(nil),         // 4: sgnl.grpc_proxy.v1.LDAPAttribute
	(*LDAPAddRequest)(nil),        // 5: sgnl.grpc_proxy.v1.LDAPAddRequest
	(*LDAPModifyChange)(nil),      // 6: sgnl.grpc_proxy.v1.LDAPModifyChange
	(*LDAPModifyRequest)(nil),     // 7: sgnl.grpc_proxy.v1.LDAPModifyRequest
	(*LDAPDeleteRequest)(nil),     // 8: sgnl.grpc_proxy.v1.LDAPDeleteRequest
	(*LDAPModifyDNRequest)(nil),   // 9: sgnl.grpc_proxy.v1.LDAPModifyDNRequest
	(*LDAPSearchOpRequest)(nil),   // 10: sgnl.grpc_proxy.v1.LDAPSearchOpRequest
	(*LDAPOperationRequest)(nil),  // 11: sgnl.grpc_proxy.v1.LDAPOperationRequest
	(*LDAPOperationResponse)(nil), // 12: sgnl.grpc_proxy.v1.LDAPOperationResponse
}
var file_proto_grpc_proxy_v1_ldap_proto_depIdxs = []int32{
	4,  // 0: sgnl.grpc_proxy.v1.LDAPAddRequest.attributes:type_name -> sgnl.grpc_proxy.v1.LDAPAttribute
	0,  // 1: sgnl.grpc_proxy.v1.LDAPModifyChange.operation:type_name -> sgnl.grpc_proxy.v1.LDAPModifyOperation
	4,  // 2: sgnl.grpc_proxy.v1.LDAPModifyChange.modification:type_name -> sgnl.grpc_proxy.v1.LDAPAttribute
	6,  // 3: sgnl.grpc_proxy.v1.LDAPModifyRequest.changes:type_name -> sgnl.grpc_proxy.v1.LDAPModifyChange
	1,  // 4: sgnl.grpc_proxy.v1.LDAPSearchOpRequest.scope:type_name -> sgnl.grpc_proxy.v1.LDAPSearchScope
	5,  // 5: sgnl.grpc_proxy.v1.LDAPOperationRequest.add_request:type_name -> sgnl.grpc_proxy.v1.LDAPAddRequest
	7,  // 6: sgnl.grpc_proxy.v1.LDAPOperationRequest.modify_request:type_name -> sgnl.grpc_proxy.v1.LDAPModifyRequest
	8,  // 7: sgnl.grpc_proxy.v1.LDAPOperationRequest.delete_request:type_name -> sgnl.grpc_proxy.v1.LDAPDeleteRequest
	9,  // 8: sgnl.grpc_proxy.v1.LDAPOperationRequest.modify_dn_request:type_name -> sgnl.grpc_proxy.v1.LDAPModifyDNRequest
	10, // 9: sgnl.grpc_proxy.v1.LDAPOperationRequest.search_request:type_name -> sgnl.grpc_proxy.v1.LDAPSearchOpRequest
...
func file_proto_grpc_proxy_v1_ldap_proto_init() {
	...
	file_proto_grpc_proxy_v1_ldap_proto_msgTypes[9].OneofWrappers = []any{
		...
		(*LDAPOperationRequest_SearchRequest)(nil),
	}
	type x struct{}
