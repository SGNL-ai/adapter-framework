...
// Maps to ldap.SearchRequest for write-like operations that need connection credentials.
type LDAPSearchOpRequest struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	BaseDn        string                 `protobuf:"bytes,1,opt,name=base_dn,json=baseDn,proto3" json:"base_dn,omitempty"`
	Scope         LDAPSearchScope        `protobuf:"varint,2,opt,name=scope,proto3,enum=sgnl.grpc_proxy.v1.LDAPSearchScope" json:"scope,omitempty"`
...
const file_proto_grpc_proxy_v1_ldap_proto_rawDesc = "" +
	...
	"\fnew_superior\x18\x04 \x01(\tR\vnewSuperior\"\xdf\x01\n" +
	"\x13LDAPSearchOpRequest\x12\x17\n" +
	"\abase_dn\x18\x01 \x01(\tR\x06baseDn\x129\n" +
	"\x05scope\x18\x02 \x01(\x0e2#.sgnl.grpc_proxy.v1.LDAPSearchScopeR\x05scope\x12\x16\n" +
	...
	"\n" +
	"time_limit\x18\x06 \x01(\x05R\ttimeLimit\"\x83\x04\n" +
